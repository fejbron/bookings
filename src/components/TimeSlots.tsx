      ...
      {slots.map(slot => {
        ...
        return (
          <button
            ...
            className={`w-full py-2.5 px-4 rounded-xl text-sm font-semibold border transition-all text-left flex items-center justify-between ${
              isSelected
          ...
          >
            ...
            <span className={`text-xs font-normal ${isSelected ? 'text-gray-400' : 'text-gray-400'}`}>
              {slot.duration}m
            </span>
          </button>
        )
